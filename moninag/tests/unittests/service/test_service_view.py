...
class TestServiceView(TestCase):
    ...
    def test_get_services(self):
        ...
        expected_response = {}
        expected_response['response'] = [to_dict(service) for service in services]

        self.assertEqual(actual_response.status_code, 200)
        self.assertJSONEqual(actual_response.content.decode('utf-8'), expected_response)
    ...
    def test_post(self):
        ...
        actual_response = self.client.post(url, data=data, content_type='application/json')
    ...
    def test_put(self):
        ...
        actual_response = self.client.put(url, data=data, content_type='application/json')
        service = Service.objects.get(id=11)
