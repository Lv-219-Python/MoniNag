...
class TestCheck(TestCase):
    def setUp(self):
        ...
        Check.objects.create(
            ...
            status=True,
            last_run=timezone.make_aware(datetime(2017, 4, 11, 20, 33), timezone.get_default_timezone()),
            target_port=3000,
            run_freq=10,
    ...
    def create_checks_set(self, number, status):
